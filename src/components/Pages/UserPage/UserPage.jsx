...
function UserPage() {
  ...
  const tooltip_mastered = (
    <Tooltip id="tooltip">
      <strong>Mark habit as mastered.</strong> Habit will be moved to awards
      page
    </Tooltip>
  );
  const tooltip_edit = (
        ...
        <div className="listOfHabits">
          ...
          <Row className="month_view_row">
            <Col className="month_view_center">
              ...
              <div
                onClick={() => {
                  const newMonthView = moment(`${monthView}`)
                    .subtract(1, "months")
                    .format("MM");
